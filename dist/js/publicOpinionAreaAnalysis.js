...
function barValue(topTenData) {
    ...
    topTenData.sort(compare("value"));
    //取到最大值
    var maxNum = parseInt(topTenData[0].value);
    //赋值
    var valueArr = [];
    topTenData.forEach(function (item, index) {
        var ratio = parseInt(item.value / maxNum * 100) + '%';
        valueArr.push(ratio);
        $('.val1').css('width', valueArr[0]);
        $('.val2').css('width', valueArr[1]);
        $('.val3').css('width', valueArr[2]);
        $('.val4').css('width', valueArr[3]);
        $('.val5').css('width', valueArr[4]);
        $('.val6').css('width', valueArr[5]);
        $('.val7').css('width', valueArr[6]);
        $('.val8').css('width', valueArr[7]);
        $('.val9').css('width', valueArr[8]);
        $('.val10').css('width', valueArr[9]);
    });
}
