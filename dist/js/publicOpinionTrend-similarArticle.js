...
$(function () {
    layui.use(['layer', 'form', 'laydate'], function () {
        ...
        form.on('select(types)', function (data) {
            ...
            switch (data.value) {
                case '1':
                    $(data.elem).parent('.types').removeClass('positive negative').addClass('positive');
                    break;
                case '2':
                    $(data.elem).parent('.types').removeClass('positive negative').addClass('neutral');
                    break;
                default:
                    $(data.elem).parent('.types').removeClass('positive neutral').addClass('negative');
                    break;
            }
        });
        //监听左侧时间范围
    ...
    $('.goBack').click(function () {
        window.location.href = "./publicOpinionTrend.html";
    });
